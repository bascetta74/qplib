...
int main(int argc, char **argv)
{
    ...
    vector<double> lB(numVar); lB.at(0) = -1.0; lB.at(1) = -1.0; lB.at(2) = -1.0; lB.at(3) = -1.0; lB.at(4) = -1.0;
    vector<double> uB(numVar); uB.at(0) = 5.0; uB.at(1) = 5.0; uB.at(2) = 5.0; uB.at(3) = 5.0; uB.at(4) = 5.0;
    ...
    MatrixXd Ain(numConstr,numVar); Ain << 1.0, -1.0, 2.0, 0.4, -0.5,
                                           2.0, -2.0, 0.5, 1.0, -1.5;
    ...
    MatrixXd Q1(numVar,numVar);     Q1 << 1.0, 0.0, 0.5, 0.0, 0.3,
                                          0.0, 4.0, 0.0, 0.4, 0.0,
                                          0.5, 0.0, 2.0, 0.0, 0.1,
                                          0.0, 0.4, 0.1, 3.0, 0.0,
                                          0.3, 0.0, 0.0, 0.1, 5.0;         Q.push_back(Q1);
    ...
    QCP_writeMatlabScript("test_6_script.m", true, lB, uB, H, f, Ain, Bin, l, Q, r, result_CPLEX, optimizerStatus);

...
int main(int argc, char **argv)
{
    ...
    MatrixXd Q1(numVar,numVar);     Q1 << 5.1, 1.0,  0.5, 1.5,  3.2,
                                          ...
                                          1.5, 0.4,  0.4, 1.7,  4.3,
                                          3.2, 1.7,  2.8, 4.3, 15.5;    Q.push_back(Q1);
    double                          r1 = 25.0;                          r.push_back(r1);

    VectorXd l2(numVar);            l2 << -0.5, 0.5, -1.5, 1.0, -2.0;   l.push_back(l2);
    MatrixXd Q2(numVar,numVar);     Q2 <<  7.0, 6.0,  4.6,  9.1,  6.9,
                                           6.0, 9.4,  5.6,  9.2,  8.6,
                                           4.6, 5.6, 10.0, 10.0, 10.0,
                                           9.1, 9.2, 10.0, 15.0, 13.0,
                                           6.9, 8.6, 10.0, 13.0, 13.0;  Q.push_back(Q2);
    ...
    QCP_writeMatlabScript("test_4_script.m", true, lB, uB, H, f, Ain, Bin, Aeq, Beq, l, Q, r, result_CPLEX, optimizerStatus);
